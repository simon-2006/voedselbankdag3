...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Voedselbank Samen'); ?></title>
...
<body class="app-body d-flex flex-column min-vh-100 <?php echo $__env->yieldContent('body_class'); ?>">
...
<?php endif; ?>
    ...
    <main class="<?php echo $__env->yieldContent('main_class', 'container py-4 py-lg-5 flex-grow-1'); ?>">
...
</html><?php /**PATH C:\Proef examen\vodselbank-op-1-dag-\resources\views/layouts/app.blade.php ENDPATH**/ ?>