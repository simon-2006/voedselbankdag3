...
<?php $__env->startSection('content'); ?>
    <section class="mb-4 reveal">
        ...
        <a href="<?php echo e(route('voorraad.index')); ?>" class="h3 text-decoration-underline">Overzicht Productvoorraden</a>
    </section>
        ...
        <article class="col-12 reveal reveal-delay-3">
            <div class="card border-0 shadow-sm h-100 card-lift">
                <div class="card-body p-4 d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
                    ...
                    <a href="<?php echo e(route('voedselpakketten.index')); ?>" class="btn btn-success px-4">Open overzicht</a>
                </div>
            </div>
        </article>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proef examen\vodselbank-op-1-dag-\resources\views/dashboard.blade.php ENDPATH**/ ?>