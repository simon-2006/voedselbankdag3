...
@section('title', 'Registreren | Voedselbank Samen')
            ...
            <div class="card border-0 shadow-lg auth-panel overflow-hidden">
                <div class="row g-0">
                    <div class="col-lg-5 p-4 p-lg-5 bg-light border-end">
                        <p class="section-eyebrow mb-2">Nieuwe aanmelding</p>
                        <h1 class="display-6 fw-semibold mb-3">Maak je account aan</h1>
                        <p class="text-secondary mb-0">Na registratie kun je hulp aanvragen en je gegevens beheren in je dashboard.</p>
                    </div>
                    ...
                    <div class="col-lg-7 p-4 p-lg-5">
                        <form method="POST" action="{{ route('register') }}" class="vstack gap-3">
                            ...
                            <div>
                                ...
                                <input id="name" name="name" type="text" value="{{ old('name') }}" class="form-control form-control-lg @error('name') is-invalid @enderror" required autocomplete="name">
                                @error('name')
                            ...
                            <div>
                                <label for="password_confirmation" class="form-label fw-semibold">Herhaal wachtwoord</label>
                            ...
                            <button type="submit" class="btn btn-primary btn-lg">Account aanmaken</button>
                        </form>
                    </div>
                </div>
            </div>
